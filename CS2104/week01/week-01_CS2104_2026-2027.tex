...
\author{
	\textbf{Sim Yue Yang} (A0308298R, yueyangsim02@gmail.com)
	\and
...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=120px]{fig1.png}
\caption{relevant \href{https://xkcd.com/1270/}{xkcd} comic}
\label{default}
\end{center}
\end{figure}
...
\begin{flushright}
\emph{2! 1! 0! 4! (to the tune of "The Blue Danube")} \\
-- Class of CS2104 (Sem 1, AY 26/27)
\end{flushright}
...
\item
  This document presents possible solutions to the exercises in the Week01 handin.

\item
  Each solution will be prefaced with the exercise it attempts to answer and a brief explanation of the learning points, followed by the group's conclusion.

\item
  The material covered in this document corresponds to the content covered in week 1 of the CS2104 module (AY 26/27).

\item
  All answers are provided to the best of the authors' ability.
...
\textbf{1.e.1} The sentence refers to itself, noting the fact that it has no verb.

\textbf{1.e.2} The subject is nostalgic for the concept of nostalgia.

\textbf{1.e.3} In the quote, fashion refers to itself. It also seems somewhat paradoxical, since it claims that fashion is something that is "no longer fashion".

\textbf{1.e.4} The 1942 film "To Be or Not to Be" references the play "Hamlet", which popularised the phrase "to be or not to be" that likely led to the naming of the 1942 film. As such, this can be considered an indirect self-reference.
...
\item
  The learning points illustrated were direct self-reference (A refers to A), and indirect self-reference (A refers to B which refers back to A).
...
\begin{itemize}
\item In Wes Anderson's movie Asteroid City, the plot revolves around a stage play with the same name, and a television documentary covering its behind-the-scenes.
...
\item The "The King in Yellow" is a book written by Robert W. Chambers which
  features a banned play in book form also called "The King in Yellow" (in the short story "The Repairer of Reputations").
  This play is read by the protagonist, turning him paranoid and eccentric, ultimately culminating in his insanity.
\item The game "Minecraft" is a free-form sandbox which allows players to build anything they can think of. This includes
  simulations of computers that can \href{https://www.youtube.com/watch?v=-BP7DhHTU-I)}{run} a simplified version of "Minecraft" itself.
...
\item
  The point of the exercise was to spot self-reference in nested media and Computer Science. In addition, it briefly touches upon the idea of
...
\item
  The learning point illustrated was that nesting and self-reference are broad concepts that can exist beyond the field of Computer Science.
...
\item
  The learning point illustrated was that the word "adventitiously" exists, and to keep the spirit of manual inquiry alive.
...
See functions Sigma0 and Sigma1 in week01.cpp. For the reader's convenience, a copy of the code is presented below:
...
The unit testing code has been omitted for brevity.
...
\item
  The use of online resources such as the On-line Encyclopedia of Integer Sequences (OEIS) to discover or identify patterns from unknown number sequences

\item
  Introducing how to simplify algorithms via characterising output patterns into formulas that can be directly computed.

\item
  Finally, caution should be taken when using AI to ensure it does not impede the learning process.
